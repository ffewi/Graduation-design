...
public class TeacherDaoImpl extends IBaseDaoImpl implements ITeacherDao {
    ...
    public List<String> getTeachingClassNameByTeacherNo(int teacherNo) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            /*
             * System.out.println(clist.size()); if (clist.size()>0) { System.out.println(clist.get(0).toString()); }
             */
            return clist;
        }
        return null;
    ...
    @Override
    public List<TeacherAddOrUpdateGrade> getStudentLuru(int teacherNo, int courseNo,
    ...
    @Override
    public List<TeacherAddOrUpdateGrade> getStudentXiugai(int teacherNo, int courseNo,
            String className, int pageNo) {
        // 查询教师可以录入的学生
        session = getSession();
    ...
    @Override
    public List<TeacherAddOrUpdateGrade> getStudentSeacherByStuName(int teacherNo, int courseNo,
