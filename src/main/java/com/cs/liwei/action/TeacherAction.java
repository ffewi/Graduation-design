...
public class TeacherAction extends ActionSupport {
	...
	public String ajaxClassNameChange() {
		// 获取班级下课程下拉
		System.out.println(tauForm.getTeacherNo() + ":  "
				+ tauForm.getClassName());
		// 获取course
	...
	public String ajaxStudentluru() {
		System.out.println("tauForm:" + tauForm.getTeacherNo() + ": "
				+ tauForm.getClassName() + ":" + tauForm.getCourseNo());
		//
		List<TeacherAddOrUpdateGrade> resultList = teacher
				.getStudentLuru(tauForm);
		if (resultList != null && !resultList.isEmpty()) {
			JSONArray json = JSONArray.fromObject(resultList);
			try {
				ServletActionContext.getResponse()
	...
	public String ajaxStudentluruCJ() {
		System.out.println("tauForm:" + tauForm.getStudentNo() + ": "
				+ tauForm.getCourseNo() + ":" + tauForm.getPingshiScore() + ":"
				+ tauForm.getExamScore());
	...
	public String changePass() {
		...
		System.out.println(" no" + tea.getTeacherNo() + ": "
				+ tea.getTeacherPwd());
		boolean result = teacher.changePass(tea.getTeacherNo(),
				tea.getTeacherPwd());
		if (result) {
			return "changePass";
		}
