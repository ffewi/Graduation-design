...
public class Score implements Serializable {
    ...
    public String toString() {
        return "Score [studentNo=" + studentNo + ", courseNo=" + courseNo + ", examType="
                + examType + ", pingshiScore=" + pingshiScore + ", examScore=" + examScore
                + ", finalScore=" + finalScore + ", gradePoint=" + gradePoint + "]";
    }
