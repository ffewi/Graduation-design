...
public interface TeacherManager {
    ...
    /**
     * 通过com.cs.liwei.bean.Method 里面的常量 包含 老师， *（看看时间够不，不够后面两个去掉） 辅导员，秘书分类 分类统计页面大小
     * 
     ...
     * @return
     */
    List<TeacherAddOrUpdateGrade> getStudentXiugai(TeacherAddOrUpdateGrade tau);
     ...
     * @return
     */
    List<TeacherAddOrUpdateGrade> getStudentSeacherByStuName(TeacherAddOrUpdateGrade tau);
     ...
     * @param tau
     */
    void updateStudnetScore(TeacherAddOrUpdateGrade tau);
}
