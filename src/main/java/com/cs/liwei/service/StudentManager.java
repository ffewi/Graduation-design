...
public interface StudentManager {
	 ...
	 */
	List<StuShowGrade> getStuMsgByTermAndByPageNo(int studentNo, int term,
			int pageNo);
	 ...
	 * @return
	 */
	List<StuShowGrade> searchStuMsgByTermAndByCourseName(int studentNo,
	 ...
	 * @return
	 */
	boolean changePassword(int studentNo, String pass);
}
