	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<s:form action="adminexeUpdateCourse" method="post">
					<div class="row input-group col-sm-4"
						...
						<span class="input-group-addon" style="width: 100px">ID</span> <input
							type="text" readonly="readonly" name="courseForm.courseNo"
							class="form-control"
							value="<s:property value="courseForm.courseNo"/>">
					</div>
					<div class="row input-group col-sm-4"
						style="margin-top: 20px; margin-left: 80px">
						<span class="input-group-addon" style="width: 100px">课程名称</span> <input
							type="text" name="courseForm.courseName" class="form-control"
							value="<s:property value="courseForm.courseName"/>">
					</div>
					<div class="row input-group col-sm-4"
						style="margin-top: 20px; margin-left: 80px">
						<span class="input-group-addon" style="width: 100px">专业名称</span> <select
							name="courseForm.selectProNo" class="form-control">

							<s:iterator id="list" value="proList">
								<option value="<s:property value="professionNo"/>"><s:property
										value="professionNo" />
					...
					<div class="row input-group col-sm-4"
						style="margin-top: 20px; margin-left: 80px">
						<span class="input-group-addon" style="width: 100px">学分</span> <select
							name="courseForm.selectCredit" class="form-control">
					...
					<div class="row input-group col-sm-4"
						style="margin-top: 20px; margin-left: 80px">
						<span class="input-group-addon" style="width: 100px">开课学期</span> <select
							name="courseForm.selectTerm" class="form-control">
							...
							<option hidden value="<s:property value="courseForm.term"/>"
								...
								<s:if test="courseForm.term==2">大一下</s:if>
								<s:if test="courseForm.term==3">大二上</s:if>
								<s:if test="courseForm.term==4">大二下</s:if>
								<s:if test="courseForm.term==5">大三上</s:if>
								<s:if test="courseForm.term==6">大三下</s:if>
								<s:if test="courseForm.term==7">大四上</s:if>
								<s:if test="courseForm.term==8">大四下</s:if>
							</option>
						</select>
					</div>
