	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<button type="button" class="btn btn-success " onclick="javascript:location.href='memberadd?msg.method=5'">添加</button>
				
				<table class="table table-striped">
                    <thead>
                    <tr>
                        <th class="col-sm-3">ID</th>
                        <th class="col-sm-3">学生名称</th>
