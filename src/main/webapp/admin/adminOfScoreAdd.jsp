	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<s:form action="memberaddScore" method="post" >
					...
					<div class="row input-group col-sm-4" style="margin-top: 20px;margin-left: 80px">
						<span class="input-group-addon" style="width:100px">平时成绩</span> <input type="text"
							name="scoreForm.pingshiScore" class="form-control" placeholder="平时成绩">
					</div>
					<div class="row input-group col-sm-4" style="margin-top: 20px;margin-left: 80px">
						<span class="input-group-addon" style="width:100px">考试成绩</span> <input type="text"
							name="scoreForm.examScore" class="form-control" placeholder="考试成绩">
					</div>
					<div class="row input-group col-sm-4" style="margin-top: 20px;margin-left: 80px">
						<span class="input-group-addon" style="width:100px">最终成绩</span> <input type="text" readonly="readonly"
							name="scoreForm.finalScore" class="form-control" placeholder="最终成绩">
					</div>
					<div class="row input-group col-sm-4" style="margin-top: 20px;margin-left: 80px">
						<span class="input-group-addon" style="width:100px">绩点</span> <input type="text" readonly="readonly"
							name="scoreForm.gradePoint" class="form-control" placeholder="考试成绩">
					</div>
					<div class="row input-group col-sm-4" style="margin-top: 20px;margin-left: 80px">
						<span class="input-group-addon" style="width:100px">课程名称</span>
						<!-- 使用select -->
						<select name="scoreForm.courseNo" class="form-control">
							<s:iterator id="list" value="scoreList">
							<option value='<s:property value="courseNo"/>'><s:property value="courseNo"/>
							<s:property value="courseName"/></option>
							</s:iterator>
						</select>
					</div>
