	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<s:form action="memberexeUpdateStudent" method="post" >
					<div class="row input-group col-sm-4" style="margin-top: 60px;margin-left: 80px">
						<span class="input-group-addon" style="width:100px">ID</span> <input type="text"  readonly="readonly"
							name="studentForm.studentNo" class="form-control" value="<s:property value="studentForm.studentNo"/>">
					</div>
					<div class="row input-group col-sm-4" style="margin-top: 20px;margin-left: 80px">
						<span class="input-group-addon" style="width:100px">学生名称</span> <input type="text"
							name="studentForm.studentName" class="form-control" value="<s:property value="studentForm.studentName"/>">
					</div>
					<div class="row input-group col-sm-4" style="margin-top: 20px;margin-left: 80px">
						...
						<select name="studentForm.sex" class="form-control">
							...
							<option hidden=""
								value="<s:property value="studentForm.sex"/>" selected>
								<s:property value="studentForm.sex" />
							</option>
						</select>
					</div>
					<div class="row input-group col-sm-4" style="margin-top: 20px;margin-left: 80px">
