	...
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				...
				<button
					class="navbar-btn navbar-right  btn btn-info text-center col-sm-1" disabled="disabled"
					type="button">查询</button>
				<form class="navbar-form navbar-right">
					<input type="text" class="form-control" disabled="disabled" placeholder="Search...">
					<!--<input type="submit" class="form-control" value="searchs">-->
				</form>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<s:form action="adminexeUpdatePro" method="get" >
					<div class="row input-group col-sm-4" style="margin-top: 60px;margin-left: 80px">
						<span class="input-group-addon" style="width:100px">ID</span> <input type="text"  readonly="readonly"
							name="proForm.professionNo" class="form-control" value="<s:property value='proForm.professionNo'/>">
					</div>
					<div class="row input-group col-sm-4" style="margin-top: 20px;margin-left: 80px">
						<span class="input-group-addon" style="width:100px">专业名称</span> <input type="text"
							name="proForm.professionName" class="form-control" placeholder="<s:property value="proForm.professionName"/>">
					</div>
					<div class="row input-group col-sm-4" style="margin-top: 20px;margin-left: 80px">
					<span class="input-group-addon" style="width:100px">院系名称</span>
