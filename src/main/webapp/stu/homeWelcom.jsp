    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="masthead clearfix">
                <div class="inner">
                    ...
                    <ul  class="nav masthead-nav">
                        <li class="active"><a href="studentindexPage">主页</a></li>
                        <li><a  href="#myModal"  data-toggle="modal" onclick="showView();">修改密码</a></li>
                        <li><a href="#">帮助</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="cover-container">
                ...
                <div class="row">
                    <p class="lead col-md-2"><s:property value="sd.avgPoint"/></p>
                    <p class="lead col-md-2"><s:property value="sd.totalXueFen"/>/170</p>
                    <p class="lead col-md-2"><s:property value="sd.biXiuXueFen"/>/40</p>
                    <p class="lead col-md-2"><s:property value="sd.tongShiXueFen"/>/36</p>
                    <p class="lead col-md-2"><s:property value="sd.xuanXiuXueFen"/>/30</p>
                    <p class="lead col-md-2"><s:property value="sd.sheHuiShiJian"/>/64</p>
                </div>
            ...
            <div class="mastfoot">
                <div class="inner">
                    <a>李伟的毕业设计 <a href="tomail://ffewi@foxmail.com">@copyright</a>, by <a href="http://www.baidu.com">@李伟</a>.</a>
                </div>
            </div>
